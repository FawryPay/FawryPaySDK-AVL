...
#ifndef FAWRYPAYSDK_AVL_SWIFT_H
#define FAWRYPAYSDK_AVL_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="FawryPaySDK_AVL",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC15FawryPaySDK_AVL18BaseViewController")
...
SWIFT_CLASS("_TtC15FawryPaySDK_AVL21AddCardViewController")
...
SWIFT_CLASS("_TtC15FawryPaySDK_AVL27BaseComponentViewController")
...
@interface BaseViewController (SWIFT_EXTENSION(FawryPaySDK_AVL)) <UIGestureRecognizerDelegate>
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC15FawryPaySDK_AVL14DesignableView")
...
SWIFT_CLASS("_TtC15FawryPaySDK_AVL28FawrySDKConfigurationManager")
@interface FawrySDKConfigurationManager : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC15FawryPaySDK_AVL15FrameworkHelper")
...
SWIFT_CLASS("_TtC15FawryPaySDK_AVL19LaunchCustomerModel")
...
SWIFT_PROTOCOL("_TtP15FawryPaySDK_AVL20OTPFieldViewDelegate_")
...
@interface PaymentDetailsViewController (SWIFT_EXTENSION(FawryPaySDK_AVL)) <UITextFieldDelegate>
- (BOOL)textField:(UITextField * _Nonnull)textField shouldChangeCharactersInRange:(NSRange)range replacementString:(NSString * _Nonnull)string SWIFT_WARN_UNUSED_RESULT;
@end
...
@interface PaymentDetailsViewController (SWIFT_EXTENSION(FawryPaySDK_AVL)) <UITableViewDataSource, UITableViewDelegate>
...
SWIFT_CLASS("_TtC15FawryPaySDK_AVL28PaymentReceiptViewController")
...
@interface PaymentReceiptViewController (SWIFT_EXTENSION(FawryPaySDK_AVL)) <UITableViewDataSource, UITableViewDelegate>
- (NSInteger)numberOfSectionsInTableView:(UITableView * _Nonnull)tableView SWIFT_WARN_UNUSED_RESULT;
- (NSInteger)tableView:(UITableView * _Nonnull)tableView numberOfRowsInSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
- (UITableViewCell * _Nonnull)tableView:(UITableView * _Nonnull)tableView cellForRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
- (CGFloat)tableView:(UITableView * _Nonnull)tableView heightForHeaderInSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_PROTOCOL("_TtP15FawryPaySDK_AVL12RowViewModel_")
@protocol RowViewModel
- (NSString * _Nonnull)cellIdentifier SWIFT_WARN_UNUSED_RESULT;
@end


SWIFT_CLASS("_TtC15FawryPaySDK_AVL24SavedCardsViewController")
...
@interface SavedCardsViewController (SWIFT_EXTENSION(FawryPaySDK_AVL)) <UITableViewDataSource, UITableViewDelegate>
- (NSInteger)tableView:(UITableView * _Nonnull)tableView numberOfRowsInSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
- (UITableViewCell * _Nonnull)tableView:(UITableView * _Nonnull)tableView cellForRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
- (CGFloat)tableView:(UITableView * _Nonnull)tableView heightForRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_CLASS("_TtC15FawryPaySDK_AVL21ThemeStyleFawryPaySDK")
